...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
 ...
 <%	if sortType="2" then%>
  ...
  <TR>
   ...
   <TR>
    <TD align=middle width=153 height=65>文章导读</TD>
    <TD colspan="3"><textarea  class="input" style="width:775px; height:40PX;" rows="3"  name="ContentGuide" ><%=ContentGuide%></textarea></TD>
    </TR>
  <%end if%>
